...
(function() {
  $(function() {
    var addSketchEl, colorThief, el, i, j, len, make_add_sketch_last, my_image, ref, sketch, sort_sketches;
    if ($('.storyboard.show #sketches').length > 0) {
      ...
      $(window).on("scrollstart", function() {
        ...
        return console.log('scroll start');
    ...
    return $(my_image).load(function() {
      ...
      return $('body').css('color', "rgb(" + the_palette[0] + ")");
    });
  });
