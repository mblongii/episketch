...
(function() {
  $(function() {
    var colorThief, color_src, i, j, len, ref, sampled_image, sketch;
    if ($('.swatch_test.index').length > 0) {
      ...
      return $(color_src).load(function() {
        var bg_color, brightest, color_swatch, darkest, k, l, len1, len2, num_colors, results, rgb, sum, sums, text_color, the_color, the_palette;
        num_colors = 8;
        ...
        console.log(the_palette.length);
        sums = [];
        ...
        text_color = the_palette["" + brightest];
        bg_color = the_palette["" + darkest];
        $('body').css('background-color', "rgb(" + bg_color + ")");
        $('body').css('color', "rgb(" + text_color + ")");
        $('p.description').css('color', "rgba(" + text_color + ", 0.55)");
        i = 0;
        results = [];
