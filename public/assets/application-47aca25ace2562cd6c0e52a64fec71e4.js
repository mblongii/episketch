...
(function() {
  $(function() {
    var colorThief, color_src, sampled_image;
    if ($('.sketch.show').length > 0) {
      ...
      return $(color_src).load(function() {
        ...
        return $('.sketch-img').last().css('background-color', "rgb(" + the_palette[2] + ")");
      });
    }
  });
...
(function() {
  $(function() {
    var addSketchEl, el, i, j, len, make_add_sketch_last, ref, sketch, sort_sketches;
    if ($('.storyboard.show #sketches').length > 0) {
      addSketchEl = $('#sketches .add-sketch');
      make_add_sketch_last = function() {
        return $('#sketches').append(addSketchEl);
      };
  ...
  $(function() {
    ...
    if ($('.storyboard.show #sketches').length > 0) {
      ...
      return $(color_src).load(function() {
        var the_color, the_palette;
        the_color = colorThief.getColor(color_src);
        the_palette = colorThief.getPalette(color_src, 8);
        console.log(the_palette);
        $('body').css('background-color', "rgb(" + the_palette[0] + ")");
        $('body').css('color', "rgb(" + the_palette[1] + ")");
        $('.add-sketch .icon').css('color', "rgb(" + the_palette[1] + ")");
        return $('.sketch-img').last().css('background-color', "rgba(" + the_palette[1] + ", 0.25)");
      });
    }
  });
