...
(function() {
  $(function() {
    ...
    if ($('.storyboard.show #sketches').length > 0) {
      ...
      return $('#sketches').append('<div class="add-sketch col-xs-24 col-sm-12 col-md-8 col-lg-8"> <img alt="Add sketch" class="img-responsive" src="/assets/add-sketch.png" /> </div>');
    }
  });
