  ...
  $(function() {
    ...
    if ($('.swatch_test.index').length > 0) {
      ...
      return $(color_src).load(function() {
        var bg_color, brightest, color_swatch, darkest, desc_color, k, l, len1, len2, next_brightest, num_colors, rgb, sum, sums, the_color, the_palette, title_color;
        num_colors = 25;
        ...
        return $('p.caption').css('color', "rgba(" + title_color + ", 0.75)");
      });
    }
  });
