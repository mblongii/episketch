...
class DesignersControllerTest < ActionController::TestCase
  ...
  test "should update designer" do
    patch :update, id: @designer, designer: { auth_token: @designer.auth_token, avatar_url: @designer.avatar_url, email: @designer.email, storyboard_id: @designer.storyboard_id, viewing_storyboard_id: @designer.viewing_storyboard_id }
    assert_redirected_to designer_path(assigns(:designer))
  end
